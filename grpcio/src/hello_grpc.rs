...
const METHOD_GREETER_SAY_HELLO: ::grpcio::Method<super::hello::HelloRequest, super::hello::HelloReply> = ::grpcio::Method {
...
impl GreeterClient {
    ...
    pub fn say_hello_opt(&self, req: &super::hello::HelloRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::hello::HelloReply> {
        self.client.unary_call(&METHOD_GREETER_SAY_HELLO, req, opt)
    }

    pub fn say_hello(&self, req: &super::hello::HelloRequest) -> ::grpcio::Result<super::hello::HelloReply> {
        self.say_hello_opt(req, ::grpcio::CallOption::default())
    }

    pub fn say_hello_async_opt(&self, req: &super::hello::HelloRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::hello::HelloReply>> {
